			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
					...
					<div className="p-6 rounded-2xl backdrop-blur-md bg-white/10 border-b border-white/20 shadow-md">
						...
						<p className="text-gray-900 dark:text-gray-400">Worked on full-stack web apps including a real-time chat application using React, Express, and Socket.io.</p>
						<p className="text-gray-700 dark:text-gray-500">Deployed on Render with full CI/CD setup.</p>
					</div>
